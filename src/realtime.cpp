...
//    std::cout << "Generated texture name: " << m_reflectionTexture << std::endl;
////    CHECK_GL_ERROR();
//    glActiveTexture(GL_TEXTURE0);
...
//    glFramebufferRenderbuffer(GL_FRAMEBUFFER, GL_DEPTH_STENCIL_ATTACHMENT, GL_RENDERBUFFER, m_reflectionRenderbuffer);
